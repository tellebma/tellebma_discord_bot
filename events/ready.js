const { set_cron_get_matchs, set_cron_check_new_events, set_cron_check_new_results } = require('../fonctions/cron/matches');
...
module.exports = {
    ...
    execute(bot) {
        ...
        set_cron_get_matchs(bot)
        set_cron_check_new_events(bot)
        set_cron_check_new_results(bot)
        /**
